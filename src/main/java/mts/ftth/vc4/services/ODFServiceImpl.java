...
public class ODFServiceImpl implements ODFService {
	...
	public ResponseEntity<APIResponse> GetODFPortList(String vc4Tocken, String odfId) {
        ...
        RequestBody body = RequestBody.create(mediaType, "");
        Request request = new Request.Builder()
                .url(vc4Token.getUrl() + "/api/ims/TEAPI_GET_MMR_ODF_PORTS_LIST/filtered/ODFID== " + odfId + " and frontback==\"F\"")
                .method("GET", null)
                .addHeader("Authorization", passToken)
                .build();
        try {
            ...
            if (!str.equals("")) {
                ...
                if (str.equals("No records found for Entity:TEAPI_GET_MMR_ODF_PORTS_LIST")) {
                    ...
                    System.out.println(vc4Token.getUrl() + "/api/ims/TEAPI_GET_MMR_ODF_PORTS_LIST/filtered/ODFID== " + odfId + "and frontback==\"F\"");
    ...
    public ResponseEntity<APIResponse> GetODFListByExch(String vc4Tocken, String exch) {
        ...
        RequestBody body = RequestBody.create(mediaType, "");
        Request request = new Request.Builder()
                .url(vc4Token.getUrl() + "/api/ims/TEAPI_GET_MMR_ODF_LIST/filtered/ID>0?ExchCode==" + exch)
                .method("GET", null)
                .addHeader("Authorization", passToken)
                .build();
        try {
            ...
            responseMsg = response.message();
            String str = response.body().string();
            System.out.println("response GetODFListByExch : " + str);
